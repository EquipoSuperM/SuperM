...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Super</span> <small style="color: #fff;">M</small></h1>
      <p>
          Bienvenido a nuestra tienda en linea SUPER M, aquí encontrara una gran variedad de artículos para el hogar.
      </p>
    </div>
